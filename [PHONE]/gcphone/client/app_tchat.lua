...
RegisterNetEvent("gcPhone:tchat_channelRETRO")
AddEventHandler("gcPhone:tchat_channelRETRO", function(channel, messages)
...
RegisterNUICallback('tchat_getChannel', function(data, cb)
  TriggerServerEvent('gcPhone:tchat_channelRETRO', data.channel)
end)
