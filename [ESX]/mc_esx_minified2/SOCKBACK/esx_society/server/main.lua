...
AddEventHandler('esx_society:withdrawMoney', function(society, amount)
  ...
  print(xPlayer.getAccount('black_money').money)

  print(society)

  TriggerEvent('esx_addonaccount:getSharedAccount', society, function(account)

    if xPlayer.getJob().name == 'cuatro' or xPlayer.getJob().name == 'vermillion'   then 
...
AddEventHandler('esx_society:depositMoney', function(society, amount)
  ...
  if xPlayer.getJob().name == 'cuatro'  or xPlayer.getJob().name == 'police'  or xPlayer.getJob().name == 'vermillion'  then 
...
RegisterServerEvent('esx_society:putVehicleRETROInGarage')
AddEventHandler('esx_society:putVehicleRETROInGarage', function(societyName, vehicle)
...
ESX.RegisterServerCallback('esx_society:getEmployees', function(source, cb, society)
  ...
  if Config.EnableESXIdentity then
    MySQL.Async.fetchAll(
      ...
      --print( Jobs[results[1].job].label) 
...
ESX.RegisterServerCallback('esx_society:getOnlRETROinePlayers', function(source, cb)
