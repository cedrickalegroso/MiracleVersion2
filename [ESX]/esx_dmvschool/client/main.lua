...
function StartTheoryTest()
	...
	TriggerServerEvent('esx_dmvschool:pRETROay', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('esx_dmvschool:addLiceRETROnse', 'dmv')
...
function StartDriveTest(type)
	...
	TriggerServerEvent('esx_dmvschool:pRETROay', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('esx_dmvschool:addLiceRETROnse', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
	else
		ESX.ShowNotification(_U('failed_test'))
	end
