...
RegisterNetEvent('esx_vehicleshop:setVehicleOwnedRETROPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedRETROPlayerId', function(playerId, vehicleProps, model, label)
