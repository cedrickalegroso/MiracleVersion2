...
Config.Zones = {
	...
	grooveActions = { -- ,, ,,
		Pos   = { x = -311.32019042969, y = -138.42475891113, z = 39.00951385498 },
	...
	Craft = { --,,
		Pos   = { x = -344.59591674805, y = -139.76171875, z = 39.009628295898 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 0, g = 204, b = 0 },
		Type  = 21,
	},
                 --,,
	VehicleSpawnPoint = {
		Pos   = { x = -359.22366333008, y = -112.93453979492, z = 38.69660949707 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = { -- ,,
		Pos   = { x = -367.30529785156, y = -108.75778961182, z = 37.68053817749 },
