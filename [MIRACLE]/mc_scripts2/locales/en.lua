Locales['en'] = {
  ...
  ['duty'] = 'Press ~INPUT_CONTEXT~ to ~g~Go On~s~/~r~Go Off~s~ duty',
	...
	['robbery_timer'] = 'Heist: ~r~%s~s~ seconds remaining',
	['recently_robbed'] = 'This place has already been robbed. Hold for ~r~%s~b~ seconds.',
	['rob_in_prog'] = '~r~Heist in progress at: ~b~%s~s~',
	['started_to_rob'] = 'you started robbing ~b~%s~s~',
	['alarm_triggered'] = 'The alarm was triggered',
	['robbery_complete'] = '~r~Heist completed~s~. You\'ve ~o~stolen~s~ ~g~$%s~s~',
	['robbery_complete_at'] = '~r~Heist completed at: ~b~%s~s~',
	['robbery_cancelled'] = 'The robbery is going to be cancelled, you won\'t win anything!',
	['robbery_cancelled_at'] = '~r~Cancelled heist at: ~b~%s~s~',
	['min_police'] = 'there must be ~b~%s police~s~ in town to rob.',
	['robbery_already'] = '~r~A robbery is already in progress.',
	['no_threat'] = 'you have to have a gun in hand',
}