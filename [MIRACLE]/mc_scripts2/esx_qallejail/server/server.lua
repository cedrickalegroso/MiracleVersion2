			...
			if jailTime ~= nil then
				...
				if args[3] ~= nil then
					GetRPName(jailPlayer, function(Firstname, Lastname)
						TriggerClientEvent('esx:showNotification', -1, Firstname.." "..Lastname.." is now in jail for: ".. args[3] , true , true, 20)
...
RegisterServerEvent("esx-ax1s-jail:jailPlayer")
AddEventHandler("esx-ax1s-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	local src = source
	...
	GetRPName(targetSrc, function(Firstname, Lastname)
		TriggerClientEvent('esx:showNotification', -1, Firstname.." "..Lastname.." is now in jail for: ".. jailReason , true , true, 20)
...
RegisterServerEvent("esx-ax1s-jail:unJailPlayer")
AddEventHandler("esx-ax1s-jail:unJailPlayer", function(targetIdentifier)
	local src = source
...
RegisterServerEvent("esx-ax1s-jail:updateJailTime")
AddEventHandler("esx-ax1s-jail:updateJailTime", function(newJailTime)
	local src = source
...
function JailPlayer(jailPlayer, jailTime)
	TriggerClientEvent("esx-ax1s-jail:jailPlayer", jailPlayer, jailTime)

	EditJailTime(jailPlayer, jailTime)
end

function UnJail(jailPlayer)
	TriggerClientEvent("esx-ax1s-jail:unJailPlayer", jailPlayer)
...
ESX.RegisterServerCallback("esx-ax1s-jail:retrieveJailedPlayers", function(source, cb)
...
ESX.RegisterServerCallback("esx-ax1s-jail:retrieveJailTime", function(source, cb)
