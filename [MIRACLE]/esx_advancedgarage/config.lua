...
Config.AmbulanceGarages = {
	Los_Santos = {
		Marker = vector3(293.15850830078,-598.16687011719,43.265953063965),
		Spawner = vector3(298.28179931641,-602.67065429688,43.212600708008),
		Spawner2 = vector3(297.56692504883,-604.69677734375,43.235149383545),
		Deleter = vector3(296.25775146484,-607.83569335938,43.256191253662),
...
Config.CarGarages = {
	Los_Santos = {
		Marker = vector3(216.34559631348,-803.85900878906,30.792318344116),
		Spawner = vector3(212.87303161621,-796.87481689453,30.323411941528),
		Deleter = vector3(223.88229370117,-761.59252929688,30.276968002319),
		Heading = 161.84
	},
	...
	Grove_Mech = {
	Marker = vector3(-362.53015136719,-147.12774658203,38.243499755859),
		Spawner = vector3(-378.01611328125,-147.56579589844,38.684257507324),
		Deleter = vector3(-379.53210449219,-143.67556762695,38.684513092041),
		Heading = 296.65
	},
...
Config.CarGaragesG = {
	...
	cartel = {
		Marker = vector3(-2463.0395507812,751.70233154297,295.02923583984),
		Spawner = vector3(-2465.6591796875,752.18829345703,295.02923583984),
		Deleter = vector3(-2470.2451171875,755.35852050781,295.02923583984),
		Heading = 13.01
	},

	ms = {
		Marker = vector3(100.62956237793,-1965.2340087891,20.844455718994),
		Spawner = vector3(104.42023468018,-1954.5108642578,20.145221710205),
		Deleter = vector3(102.93041229248,-1956.958984375,20.746826171875),
		Heading = 345.01
	},

	
	gambino = {
		Marker = vector3(-103.28409576416,829.49481201172,235.66677856445),
		Spawner = vector3(-105.39107513428,834.55993652344,235.70101928711),
		Deleter = vector3(-104.78802490234,825.36315917969,235.72462463379),
		Heading = 9.01
	},

	sillian = {
		Marker = vector3(-1411.1323242188,659.05590820312,186.99945068359),
		Spawner = vector3(-1412.3626708984,666.48760986328,184.99948120117),
		Deleter = vector3(-1417.0430908203,660.30035400391,186.99945068359),
		Heading = 9.01
	},
}
...
Config.CarPounds = {
	Los_Santos = {
		Marker = vector3(409.89111328125,-1624.3470458984,29.291938781738),
		Spawner = vector3(402.92135620117,-1640.6901855469,29.291938781738),
		Heading = 224.54
	},
	Sandy_Shores = {
