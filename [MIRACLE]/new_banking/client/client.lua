...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('bank:depRETROosit', tonumber(data.amount))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('bank:withdRETROraw', tonumber(data.amountw))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('bank:tranRETROsfer', data.to, data.amountt)
	TriggerServerEvent('bank:balance')
end)
