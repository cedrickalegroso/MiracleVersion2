...
local function craftItem(ingredients)
	...
	TriggerServerEvent('ax1s_crafting:craftItem', ingredientsPrepped)
end

RegisterNetEvent('ax1s_crafting:openMenu')
AddEventHandler('ax1s_crafting:openMenu', function(playerInventory)
...
--Citizen.CreateThread(function()
	...
	--		TriggerServerEvent('ax1s_crafting:getPlayerInventory')
	--	end
	--end
--end)
