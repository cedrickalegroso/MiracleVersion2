...
function skup()
	...
	TriggerServerEvent('smerfikcraft:skRETROup2')
...
local blips = {
	...
	{title="Scrapman Job", colour=5, id=468, x = -491.240, y = -1753.890, z = 19.00},
	{title="Scrapman Job", colour=5, id=488, x = -430.060, y = -1726.750, z = 29.90},
	{title="Scrapman Job", colour=5, id=479, x = -422.020, y = -1720.250, z = 43.370}
