...
function UTK:GetInfo()
    ESX.TriggerServerCallback("be-bigbank:GetData", function(output)
        self.info = output
        self:HandleInfo()
    end)
end
                    ...
                    local coords = GetEntityCoords(PlayerPedId())
                        ...
                        if dst <= 6 then
                            ...
                            if dst <= 1 and IsControlJustReleased(0,38) then
                                ESX.TriggerServerCallback("be-bigbank:startevent", function(output)
                                    if output == true then
                                        UTK.initiator = true
                                        self.info.stage = 1
                                        self.info.style = 1
                        ...
                        while true do
                            ...
                            if not UTK.checks.hack1 then
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("be-bigbank:checkItem", function(output)
                                            if output then
                            ...
                            if UTK.checks.id1 and not UTK.checks.id2 then
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("be-bigbank:checkItem", function(output)
                                        if output then
                                            TriggerServerEvent("be-bigbank:removeitem", "id_card")
                                            UTK.checks.id2 = true
                                            self.currentid = 2
                                            self:IdCard()
                                        elseif not output then
                            ...
                            if not UTK.checks.thermal1 then
                                ...
                                if dst <= 4 then
                                    ...
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("be-bigbank:checkItem", function(output)
                                            if output then
                                                TriggerServerEvent("be-bigbank:removeitem", "thermal_charge")
                                ...
                                if not UTK.checks.lockpick1 then
                                    ...
                                    if dst <= 4 then
                                        ...
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("be-bigbank:checkItem", function(output)
                                                if output then
                                                    TriggerServerEvent("be-bigbank:removeitem", "lockpick")
...
function UTK:Plant()
    ...
    DeleteObject(bag)
	--RemoveObj(NetworkGetNetworkIdFromEntity(bag))
    SetPedComponentVariation(ped, 5, 45, 0, 0)
    DetachEntity(bomba, 1, 1)
    FreezeEntityPosition(bomba, true)
    TriggerServerEvent("be-bigbank:ptfx", method)
    ...
    if self.currentplant == 0 then
        TriggerServerEvent("be-bigbank:fixdoor", self.doorchecks[1].h, vector3(self.doorchecks[1].x, self.doorchecks[1].y, self.doorchecks[1].z), self.doorchecks[1].he)
    elseif self.currentplant == 1 then
        TriggerServerEvent("be-bigbank:fixdoor", self.doorchecks[4].h, vector3(self.doorchecks[4].x, self.doorchecks[4].y, self.doorchecks[4].z), self.doorchecks[4].he)
    elseif self.currentplant == 2 then
        TriggerServerEvent("be-bigbank:fixdoor", self.doorchecks[5].h, vector3(self.doorchecks[5].x, self.doorchecks[5].y, self.doorchecks[5].z), self.doorchecks[5].he)
    end
    ...
    Citizen.Wait(2000)
    if self.currentplant == 0 then
        TriggerServerEvent("be-bigbank:alarm_s", 1)
    end
    DeleteObject(bomba)
	--RemoveObj(NetworkGetNetworkIdFromEntity(bomba))
    TriggerServerEvent("be-bigbank:moltgate", loc.x, loc.y, loc.z, oldmodel, newmodel)
    Citizen.Wait(9000)
    ...
    if self.currentplant == 0 then
        --TriggerServerEvent("be-bigbank:toggleDoor", newmodel, vector3(self.loudstart.x, self.loudstart.y, self.loudstart.z), false)
        TriggerServerEvent("be-bigbank:policeDoor", 1, false)
        self:HandleInfo()
    elseif self.currentplant == 1 then
        --TriggerServerEvent("be-bigbank:toggleDoor", newmodel, vector3(self.inside1.x, self.inside1.y, self.inside1.z), false)
        TriggerServerEvent("be-bigbank:policeDoor", 4, false)
    elseif self.currentplant == 2 then
        --TriggerServerEvent("be-bigbank:toggleDoor", newmodel, vector3(self.inside2.x, self.inside2.y, self.inside2.z), false)
        TriggerServerEvent("be-bigbank:policeDoor", 5, false)
    end
end
function UTK:Lockpick()
    ...
    if self.currentpick == 0 then
        UTK.stage0break = true
        --TriggerServerEvent("be-bigbank:toggleDoor", self.silentstart.type, vector3(self.silentstart.x, self.silentstart.y, self.silentstart.z), false, self.silentstart.h)
        TriggerServerEvent("be-bigbank:policeDoor", 2, false)
        self:HandleInfo()
    elseif self.currentpick == 1 then
        --TriggerServerEvent("be-bigbank:toggleDoor", self.inside1.type, vector3(self.inside1.x, self.inside1.y, self.inside1.z), false, self.inside1.h)
        TriggerServerEvent("be-bigbank:policeDoor", 4, false)
    elseif self.currentpick == 2 then
        --TriggerServerEvent("be-bigbank:toggleDoor", self.inside1.type, vector3(self.inside2.x, self.inside2.y, self.inside2.z), false, self.inside2.h)
        TriggerServerEvent("be-bigbank:policeDoor", 5, false)
    end
end
function UTK:Hack()
    ...
    DeleteObject(card)
	--RemoveObj(NetworkGetNetworkIdFromEntity(bag))
	--RemoveObj(NetworkGetNetworkIdFromEntity(laptop))
	--RemoveObj(NetworkGetNetworkIdFromEntity(card))
    FreezeEntityPosition(ped, false)
    SetPedComponentVariation(ped, 5, 45, 0, 0)
end
function UTK:IdCard()
    UTK.disableinput = true
    RequestModel("p_ld_chip_01")
    while not HasModelLoaded("p_ld_chip_01") do
        Citizen.Wait(1)
    end
    local ped = PlayerPedId()
    ...
    local IdProp = CreateObject(GetHashKey("p_ld_chip_01"), pedco, true, true, false)
    ...
    if self.currentid == 1 then
        ...
        --TriggerServerEvent("be-bigbank:toggleDoor", UTK.hack1.type, vector3(UTK.hack1.x, UTK.hack1.y, UTK.hack1.z), false, UTK.hack1.h)
        TriggerServerEvent("be-bigbank:policeDoor", 3, false)
    elseif self.currentid == 2 then
       ...
       -- SpawnObj()
        TriggerServerEvent("be-bigbank:openvault", 1)
        TriggerEvent("be-bigbank:vaulttimer", 2)
        TriggerServerEvent("be-bigbank:alarm_s", 1)
        self.info.stage = 2
        self.info.style = 2
        self:HandleInfo()
...
--[[function SpawnObj()
    ...
    --TriggerServerEvent("be-bigbank:startloot")
end
function Loot(currentgrab)
			    ...
			    if HasAnimEventFired(ped, GetHashKey("RELEASE_CASH_DESTROY")) then
				    if IsEntityVisible(grabobj) then
                        ...
                        if currentgrab < 4 then
                            TriggerServerEvent("be-bigbank:rewardCash")
                        elseif currentgrab == 4 then
                            TriggerServerEvent("be-bigbank:rewardGold")
                        elseif currentgrab == 5 then
                            TriggerServerEvent("be-bigbank:rewardDia")
                        end
				    end
			    end
		    end
		    --DeleteObject(grabobj)
			RemoveObj(NetworkGetNetworkIdFromEntity(grabobj))
	    end)
    end
    ...
    if not Grab3clear then
		...
		RemoveObj(NetworkGetNetworkIdFromEntity(Trolley))
...
function Search(location)
    ...
    if UTK.searchinfo.random ~= 1 then
        ...
        TriggerServerEvent("be-bigbank:giveidcard")
    end
        ...
        if HasScaleformMovieLoaded(scaleform) and UsingComputer then
            ...
            if GetScaleformMovieFunctionReturnBool(ClickReturn) then
                ...
                if program == 82 and not Hacking then
                    ...
                    PopScaleformMovieFunctionVoid()
                    Hacking = true
                    exports["mythic_notify"]:DoHudText("success", "Find the IP...")
                ...
                elseif Hacking and program == 86 then
                    ...
                    elseif UTK.hackmethod == 2 then
                      -- SpawnObj()
                        ...
                        TriggerEvent("be-bigbank:vaulttimer", 1)
                        TriggerServerEvent("be-bigbank:openvault", 1)
                        exports['mythic_notify']:DoHudText("success", UTK.text.hacked)
                        UTK.disableinput = false
                        UTK.hackfinish = true
...
RegisterNetEvent("be-bigbank:policeDoor_c")
AddEventHandler("be-bigbank:policeDoor_c", function(doornum, status)
    PoliceDoors[doornum].locked = status
end)
RegisterNetEvent("be-bigbank:openvault_c")
AddEventHandler("be-bigbank:openvault_c", function(method)
    TriggerEvent("be-bigbank:vault", method)
    TriggerEvent("be-bigbank:vaultsound")
end)
RegisterNetEvent("be-bigbank:vault")
AddEventHandler("be-bigbank:vault", function(method)
...
RegisterNetEvent("be-bigbank:vaultsound")
AddEventHandler("be-bigbank:vaultsound", function()
    local coords = GetEntityCoords(PlayerPedId())
    local count = 0
...
RegisterNetEvent('be-bigbank:alarm')
AddEventHandler('be-bigbank:alarm', function(status)
    if status == 1 then
        PlaySound = true
...
RegisterNetEvent("be-bigbank:updatecheck_c")
AddEventHandler("be-bigbank:updatecheck_c", function(var, status)
    UTK.checks[var] = status
end)
--[[RegisterNetEvent("be-bigbank:startloot_c")
AddEventHandler("be-bigbank:startloot_c", function()
    UTK.startloot = true
end)--]]
RegisterNetEvent("be-bigbank:vaulttimer")
AddEventHandler("be-bigbank:vaulttimer", function(method)
    if method == 1 then
        exports['mythic_notify']:DoHudText("error", "You have 500 seconds left before gas release.")
        UTK.starttimer = true
        UTK.vaulttime = 500
        Citizen.CreateThread(function()
            while true do
        ...
        TriggerServerEvent("be-bigbank:ostimer")
        TriggerServerEvent("be-bigbank:gas")
        Citizen.CreateThread(function()
        ...
        Citizen.Wait(50000)
        UTK.begingas = false
        TriggerServerEvent("be-bigbank:alarm_s", 2)
        ESX.TriggerServerCallback("be-bigbank:gettotalcash", function(result)
            text = "$"..ESX.Math.GroupDigits(result)
            exports["mythic_notify"]:DoHudText("success", "You stole "..text)
        end)
    else
        exports['mythic_notify']:DoHudText("error", "You have 600 seconds before gas release.")
        UTK.starttimer = true
        UTK.vaulttime = 90
        Citizen.CreateThread(function()
            while true do
...
RegisterNetEvent("be-bigbank:gas_c")
AddEventHandler("be-bigbank:gas_c", function()
    Citizen.CreateThread(function()
        UTK.begingas = true
        exports["mythic_notify"]:DoHudText("error", "Vault is gonna be sealed in 60 seconds")
        while true do
            Citizen.Wait(1)
            if UTK.begingas then
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if UTK.begingas then
                ...
                UTK.stage2break = true
                UTK.stage4break = true
                exports["mythic_notify"]:DoHudText("error", "CLOSING VAULT")
                TriggerEvent("be-bigbank:vault", 2)
                TriggerEvent("be-bigbank:vaultsound")
                for k, v in ipairs(UTK.doorchecks) do
                    if k == 1 or k == 4 or k == 5 then
                        TriggerEvent("be-bigbank:moltgate_c", v.x, v.y, v.z, v.h1, v.h2, 2)
                    end
                end
                UTK.begingas = false
                return
...
RegisterNetEvent("be-bigbank:policenotify")
AddEventHandler("be-bigbank:policenotify", function()
    TriggerServerEvent('MF_Trackables:Notify',"Alarm triggered on Pacific Bank",GetEntityCoords(GetPlayerPed(-1)),"police")
end)

--[[RegisterNetEvent("be-bigbank:toggleDoor_c")
AddEventHandler("be-bigbank:toggleDoor_c", function(door, coord, status)
    local obj = ESX.Game.GetClosestObject(door, coord)

    FreezeEntityPosition(obj, status)
end)]]
RegisterNetEvent("be-bigbank:moltgate_c")
AddEventHandler("be-bigbank:moltgate_c", function(x, y, z, oldmodel, newmodel, method)
    if method == 2 then
...
RegisterNetEvent("be-bigbank:fixdoor_c")
AddEventHandler("be-bigbank:fixdoor_c", function(hash, coords, heading)
...
RegisterNetEvent("be-bigbank:ptfx_c")
AddEventHandler("be-bigbank:ptfx_c", function(method)
    local ptfx
...
RegisterNetEvent("be-bigbank:reset")
AddEventHandler("be-bigbank:reset", function()
    UTK.stage1break = true
    UTK.stage2break = true
    UTK.stage4break = true
    UTK.stagelootbreak = false
                ...
                if not UTK.checks.grab1 then
                    ...
                    if dst1 <= 4 then
                        ...
                        if dst1 < 1 and IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent("be-bigbank:updatecheck", "grab1", true)
                            Loot(1)
                        end
                    end
                end
                if not UTK.checks.grab2 then
                    ...
                    if dst2 <= 4 then
                        ...
                        if dst2 < 1 and IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent("be-bigbank:updatecheck", "grab2", true)
                            Loot(2)
                        end
                    end
                end
                if not UTK.checks.grab3 then
                    ...
                    if dst3 <= 4 then
                        ...
                        if dst3 < 1 and IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent("be-bigbank:updatecheck", "grab3", true)
                            Loot(3)
                        end
                    end
                end
                if not UTK.checks.grab4 then
                    ...
                    if dst4 <= 4 then
                        ...
                        if dst4 < 1 and IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent("be-bigbank:updatecheck", "grab4", true)
                            Loot(4)
                        end
                    end
                end
                if not UTK.checks.grab5 then
                    ...
                    if dst5 <= 4 then
                        ...
                        if dst5 < 1 and IsControlJustReleased(0, 38) then
                            ...
                            TriggerServerEvent("be-bigbank:updatecheck", "grab5", true)
                            Loot(5)
                        end
                    end
                end
...
Citizen.CreateThread(function()
    ...
    ESX.TriggerServerCallback("be-bigbank:GetDoors", function(result)
        PoliceDoors = result
    end)
            ...
            if dst <= 50 then
                ...
                if PlayerData.job.name == "police" then
                    if dst <= 1.5 then
                        ...
                        if IsControlJustReleased(0, 38)  then
                            TriggerServerEvent("be-bigbank:policeDoor", k, state)
                        end
                    end
                end
            end
...
Citizen.CreateThread(function() while ESX == nil do TriggerEvent('esx:getShRETROaredObjRETROect', function(obj) ESX = obj end) Citizen.Wait(1) end Citizen.Wait(10000) UTK:GetInfo() end)
