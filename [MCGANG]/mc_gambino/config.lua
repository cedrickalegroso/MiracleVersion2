...
Config.GordoStations = {
	...
	LSPD = {
		...
		Blip = {
			Coords  = vector3(-100.04598236084,836.68597412109,235.72280883789),
			Sprite  = 84,
			Display = 4,
			Scale   = 1.0,
			Colour  = 29
		...
		Armories = {
			vector3(-59.073871612549,846.75946044922,235.7181854248)
		},
			...
			
	{
		...
		BossActions = {
			vector3(-60.027061462402,840.76654052734,235.7181854248)
