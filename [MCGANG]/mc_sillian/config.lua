...
Config.GordoStations = {
	...
	LSPD = {
		...
		Blip = {
			Coords  = vector3(-1413.5079345703,658.791015625,197.10018920898),
			Sprite  = 84,
			Display = 4,
			Scale   = 1.0,
			Colour  = 29
		...
		Armories = {
			vector3(-1407.9254150391,643.93786621094,197.09945678711)
		},
			...
			
	{
		...
		BossActions = {
			vector3(-1411.8511962891,623.34112548828,197.12649536133)
