...
MyricaS.GeneralDiscordWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6" -- General logging system (Here you will find ALL logs) -- Required.

MyricaS.EntitiesDiscordWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6"  -- Optional , Logging Entities only webhook
MyricaS.WeaponsDiscordWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6"  -- Optional , Logging Weapons detection only webhook
MyricaS.BlacklistedEventsWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6" -- Optional , Logging Blacklisted Events detection only webhook
MyricaS.ExplosionsDiscordWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6" -- Optional , Logging Explosions only webhook
MyricaS.SeclyDiscordWebhookLink = "https://discordapp.com/api/webhooks/772480110209138688/xwNODnf-m6Y2pGxzaTdmoYDAFJcqPnQUL3weqt7R8D_WA3X6bpHrgxrXn0l90C1e74x6" -- Optional , Logging Secly only webhook (Modmenu Injections,Lua manipulation)
...
--//Ban System//--
MyricaS.ForceDiscord = true -- This will force the users to have discord linked to discord (Most of the cheaters will not use Discord on FiveM)
...
MyricaS.BanSystem = true -- This on false will disable the ChocoHax's Ban System
    MyricaS.KickMessage = "YOU HAVE BEEN BANNED FROM RETRO CITY - RETRO PREMIUM AC" -- You can edit this UwU
